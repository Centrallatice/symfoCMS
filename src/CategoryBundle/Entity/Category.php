...
class Category
{
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="CategoryBundle\Entity\Category", cascade={"remove"})
     ...
     * @var string
     *
     * @ORM\Column(name="type", type="string", columnDefinition="enum('article', 'page')")
     */
    private $type;
     ...
     * Set categoryParente
     *
     * @param \CategoryBundle\Entity\Category $categoryParente
     *
     * @return Category
     */
    public function setCategoryParente(\CategoryBundle\Entity\Category $categoryParente = null)
    {
     ...
     * Add categoryEnfant
     *
     * @param \CategoryBundle\Entity\Category $categoryEnfant
     *
     * @return Category
     */
    public function addCategoryEnfant(\CategoryBundle\Entity\Category $categoryEnfant)
    {
     ...
     * @param \CategoryBundle\Entity\Category $categoryEnfant
     */
    public function removeCategoryEnfant(\CategoryBundle\Entity\Category $categoryEnfant)
    {
