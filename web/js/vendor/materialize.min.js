        ...
        var b = {
            init: function(b) {
                ...
                b = a.extend(c, b), a(this).each(function() {
                    ...
                    var f = function(c) {
                            g = !1, h = !1, a("body").removeClass("collapsibleBody"), a("body").css({
                                overflow: "",
                                width: ""
                ...
                if (!d.hasClass("browser-default")) {
                    ...
                    var i = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        n = function(b, c, d) {
                            ...
                            "multiple" === d ? i.append(a('<li class="' + e + '"><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + f + '"><span>' + c.html() + "</span>"+(c.attr("data-desc") ? "<span class='option-description'>"+c.attr("data-desc")+"</span>": "")+"</li>"))
                        };
                        ...
                        a(this).click(function(g) {
                            ...
                            if (!a(this).hasClass("disabled") && !a(this).hasClass("optgroup")) {
                                ...
                                e ? (a('input[type="checkbox"]', this).prop("checked", function(a, b) {
                                    return !b
                                }), h = c(k, a(this).index(), d), q.trigger("focus")) : (i.find("li").removeClass("active"), a(this).toggleClass("active"), q.val(a(this).find("span:not(.option-description)").text())), r(i, a(this)), d.find("option").eq(f).prop("selected", h), d.trigger("change"), "undefined" != typeof b && b()
                            }
                            g.stopPropagation()
                        })
                    }), d.wrap(h);
